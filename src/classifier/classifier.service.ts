...
<rules>
1. Если запрос требует получения данных из API, работы с базой данных, вызова внешних сервисов - создай задачу HTTP_TOOL с соответствующим промптом
2. Если запрос требует простого ответа, объяснения, генерации текста - создай задачу GENERATE с полным промптом
...
5. HTTP_TOOL используй для: получения данных, создания записей, обновления, удаления, работы с API
</rules>
...
<response>`;
  ...
  private getAvailableCommands(): string {
    const commandDescriptions = {
      ...
      [Command.HTTP_TOOL]: 'Обращение к HTTP API для получения данных, работы с базой данных, вызова внешних сервисов',
    };
